...
const $containerBase: ViewStyle = {
  ...
  borderWidth: 1,
  shadowColor: colors.palette.greyscale["800"],
...
const $containerPresets = {
  default: [
    $containerBase,
    {
      ...
      borderColor: colors.palette.greyscale["300"],
    },
  ] as StyleProp<ViewStyle>,

  reversed: [
    $containerBase,
    { backgroundColor: colors.palette.greyscale["800"], borderColor: colors.palette.greyscale["500"] },
  ] as StyleProp<ViewStyle>,
}

const $headingPresets: Record<Presets, TextStyle> = {
  default: {},
  reversed: { color: colors.palette.greyscale["100"] },
}
