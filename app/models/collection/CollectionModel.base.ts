...
export const CollectionModelBase = withTypedRefs<Refs>()(ModelBase
  ...
  .props({
    ...
    taggedGroups: types.union(types.undefined, types.null, types.array(MSTGQLRef(types.late((): any => GroupModel)))),
    taggedIdols: types.union(types.undefined, types.null, types.array(MSTGQLRef(types.late((): any => IdolModel)))),
  })
  .views(self => ({
    get store() {
...
export class CollectionModelSelector extends QueryBuilder {
  ...
  taggedGroups(builder: string | GroupModelSelector | ((selector: GroupModelSelector) => GroupModelSelector) | undefined) { return this.__child(`taggedGroups`, GroupModelSelector, builder) }
  taggedIdols(builder: string | IdolModelSelector | ((selector: IdolModelSelector) => IdolModelSelector) | undefined) { return this.__child(`taggedIdols`, IdolModelSelector, builder) }
}
