...
export class TalentModelSelector extends QueryBuilder {
  ...
  group(builder?: string | GroupModelSelector | ((selector: GroupModelSelector) => GroupModelSelector)) { return this.__inlineFragment(`Group`, GroupModelSelector, builder) }
  idol(builder?: string | IdolModelSelector | ((selector: IdolModelSelector) => IdolModelSelector)) { return this.__inlineFragment(`Idol`, IdolModelSelector, builder) }
}
